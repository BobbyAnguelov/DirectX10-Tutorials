...
bool dxManager::initializeObjects()
{
	...
	//load textures
	if (	FAILED(D3DX10CreateShaderResourceViewFromFile( pD3DDevice, "textures/diffuse.bmp", NULL, NULL, &pDiffuseTex, NULL )) 
		||	FAILED(D3DX10CreateShaderResourceViewFromFile( pD3DDevice, "textures/alpha.png", NULL, NULL, &pAlphaTex, NULL ))
		)
	{
